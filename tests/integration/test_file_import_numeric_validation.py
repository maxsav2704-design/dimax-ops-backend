...
@pytest.mark.parametrize(
    "value",
    [
        "1.5", "1,5", "1.00000000000000001", "1000.1", "NaN", "Infinity",
        "-Infinity", "0", "1001", "1e1000", "bad",
    ],
)
...
@pytest.mark.parametrize(
    ("value", "expected"),
    [(None, 1), (" ", 1), ("1", 1), ("1.0", 1), ("2,0", 2), ("2e1", 20), ("1000", 1000)],
)
...
@pytest.mark.parametrize(
    ("value", "expected"),
    [(None, "250"), (" ", "250"), ("0", "0"), ("0.01", "0.01"), ("12,50", "12.50"), ("1e3", "1000")],
)
